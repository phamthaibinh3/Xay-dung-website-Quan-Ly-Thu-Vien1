const actionTypes = Object.freeze({
    ...
    GET_LUOTTHICH_SUCCESS: 'GET_LUOTTHICH_SUCCESS',
    GET_LUOTTHICH_FAIL: 'GET_LUOTTHICH_FAIL',

    GET_PHIEUMUON_SUCCESS: 'GET_PHIEUMUON_SUCCESS',
    GET_PHIEUMUON_FAIL: 'GET_PHIEUMUON_FAIL',

    DUYET_PHIEUMUON_SUCCESS: 'DUYET_PHIEUMUON_SUCCESS',
    DUYET_PHIEUMUON_FAIL: 'DUYET_PHIEUMUON_FAIL',

    HUY_PHIEUMUON_SUCCESS: 'HUY_PHIEUMUON_SUCCESS',
    HUY_PHIEUMUON_FAIL: 'HUY_PHIEUMUON_FAIL',

    TAO_PHIEUMUON_SUCCESS: 'TAO_PHIEUMUON_SUCCESS',
    TAO_PHIEUMUON_FAIL: 'TAO_PHIEUMUON_FAIL',

    GET_ALL_TLNB_SUCCESS: 'GET_ALL_TLNB_SUCCESS',
    GET_ALL_TLNB_FAIL: 'GET_ALL_TLNB_FAIL',

    GET_ALL_TLMN_SUCCESS: 'GET_ALL_TLMN_SUCCESS',
    GET_ALL_TLMN_FAIL: 'GET_ALL_TLMN_FAIL',

    TRA_THUE_SACH_SUCCESS: 'TRA_THUE_SACH_SUCCESS',
    TRA_THUE_SACH_FAIL: 'TRA_THUE_SACH_FAIL',

    GET_THUE_SACH_SUCCESS: 'GET_THUE_SACH_SUCCESS',
    GET_THUE_SACH_FAIL: 'GET_THUE_SACH_FAIL',

    FETCH_NHANVIEN_SUCESS: 'FETCH_NHANVIEN_SUCESS',
    FETCH_NHANVIEN_FAIL: 'FETCH_NHANVIEN_FAIL',
    ...
    DOI_MK_SUCCESS: 'DOI_MK_SUCCESS',
    DOI_MK_FAIL: 'DOI_MK_FAIL',

    SACH_THEO_DANH_MUC_SUCCESS: 'SACH_THEO_DANH_MUC_SUCCESS',
    SACH_THEO_DANH_MUC_FAIL: 'SACH_THEO_DANH_MUC_FAIL',
